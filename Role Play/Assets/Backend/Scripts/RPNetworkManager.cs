...
namespace RP.Backend.Network
{
    public class RPNetworkManager : NetworkManager
    {
        #region INSPECTOR
        ...
        protected virtual void CreatePlayerRequestHandler(NetworkConnection connection)
        {
